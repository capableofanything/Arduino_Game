...
public class Manager : MonoBehaviour {
    ...
    public string data = "";
    string[] presentdata;
    string received_message;//data 읽기
	...
	void OnMessageReceived () {
        ...
        instance.presentdata = instance.data.Split(',');
		if(presentdata.Length>2)       
			instance.rot = new Vector3(float.Parse(instance.presentdata[1]), float.Parse(instance.presentdata[2]), 0f);
    }
